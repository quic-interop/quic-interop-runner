...
**Handshake** (`handshake`): Tests the successful completion of the handshake. Both client and server save the negotiated protocol in a file called `negotiated_protocol.txt` in `/downloads/`.
